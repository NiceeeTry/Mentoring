...
class Titanic:
    ...
    def __init__(self):
        self.titanic_data = pd.read_csv("../data/train.csv")
        self.titanic_test_data = pd.read_csv("../data/test.csv")
        self.pipline = Pipeline([("ageimputer", AgeImputer()), 
    ...
    def run(self):
        ...
        X_data_final_test = self.prediction_data_processing()
    ...
    def data_preprocessing(self, strat_train_set):
    ...
    def trainig(self, X_data, Y_data):
    ...
    def prediction_data_processing(self):
    ...
    def training_data_preparation(self, training_set):
